...
public class ViewService extends RelativeLayout implements ViewBaseAction{
	...
	public ViewService(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context);
	}

	public ViewService(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context);
	}
	...
	private void init(Context context) {
		...
		String[] listZl = AppContext.getConfigration(mContext, "zhonglei2").split(",");
